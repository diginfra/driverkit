...
LDFLAGS := -X github.com/diginfra/driverkit/pkg/version.buildTime=$(shell date +%s) -X github.com/diginfra/driverkit/pkg/version.gitCommit=${GIT_COMMIT} -X github.com/diginfra/driverkit/pkg/version.gitTag=$(if ${GIT_TAG},${GIT_TAG},v0.0.0) -X github.com/diginfra/driverkit/pkg/version.commitsFromGitTag=${COMMITS_FROM_GIT_TAG} -X github.com/diginfra/driverkit/pkg/driverbuilder/builder.defaultImageTag=$(GIT_COMMIT)
