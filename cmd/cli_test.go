...
var tests = []testCase{
	...
	},
	{
		...
		env: map[string]string{
			...
			"DRIVERKIT_OUTPUT_MODULE": "/tmp/diginfra-ubuntu-aws.ko",
			"DRIVERKIT_OUTPUT_PROBE":  "/tmp/diginfra-ubuntu-aws.o",
		},
		args: []string{
			"docker",
			"--kernelrelease",
