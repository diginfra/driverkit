...
import (
	...
	"github.com/diginfra/driverkit/pkg/kubernetes/factory"
...
func NewKubernetesInClusterCmd(configOpts *ConfigOptions, rootOpts *RootOptions, rootFlags *pflag.FlagSet) *cobra.Command {
	kubernetesInClusterCmd := &cobra.Command{
		...
		Short:   "Build Diginfra kernel modules and eBPF probes against a Kubernetes cluster inside a Kubernetes cluster.",
